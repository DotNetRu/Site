...
Topics:
  ...
  - Subject: .NET 5 Networking Improvements
    Timestamp: 00:04:10
    Links:
      - https://devblogs.microsoft.com/dotnet/net-5-new-networking-improvements/

  - Subject: What's next for System.Text.Json?
    Timestamp: 00:16:53
    Links:
      - https://devblogs.microsoft.com/dotnet/whats-next-for-system-text-json/

  - Subject: Plan for Entity Framework Core 6.0
    Timestamp: 00:30:20
    Links:
      - https://docs.microsoft.com/en-us/ef/core/what-is-new/ef-core-6.0/plan
      - https://github.com/dotnet/efcore/issues/23884
      - https://devblogs.microsoft.com/dotnet/the-plan-for-entity-framework-core-6-0/

  - Subject: Duende IdentityServer v5 Release
    Timestamp: 00:41:20
    Links:
      - https://blog.duendesoftware.com/posts/20210114_v5_release/

  - Subject: Hydra 2020 Playlist
    Timestamp: 00:47:39
    Links:
      - https://www.youtube.com/watch?v=PMVBuMK_pJY&list=PLC5OGTO4dWxZId5x2ZRFmujuef_-jP-c7
      - https://hydraconf.com/

  - Subject: Publishing mode for Docker images
    Timestamp: 00:53:52
    Links:
      - https://andrewlock.net/should-i-use-self-contained-or-framework-dependent-publishing-in-docker-images/

  - Subject: Power Users Tool List for Windows
    Timestamp: 01:01:22
    Links:
      - https://www.hanselman.com/blog/scott-hanselmans-2021-ultimate-developer-and-power-users-tool-list-for-windows

  - Subject: Fun with IConfiguration
    Timestamp: 01:17:19
    Links:
      - https://bakedbean.org.uk/posts/2021-01-fun-with-iconfiguration/
      - https://github.com/StackExchange/StackExchange.Utils

  - Subject: Rethinking OSS Attribution In .NET
    Timestamp: 01:24:47
    Links:
      - https://khalidabuhakmeh.com/rethinking-oss-attribution-in-net

  - Subject: Подслушано
    Timestamp: 01:28:55
    Links:
      - https://linkmeup.ru/blog/608.html
      - https://podlodka.io/190
      - https://devzen.ru/episode-0318/
      - https://www.dotnetrocks.com/default.aspx?ShowNum=1722
      - https://dry.redmadrobot.dev/issue_12
