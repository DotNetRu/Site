...
Topics:
  ...
  - Subject: ReSharper and Rider 2021.1 roadmap
    Timestamp: 00:03:01
    Links:
      ...
      - https://blog.jetbrains.com/dotnet/2021/01/26/answering-your-questions-reddit/
      - https://blog.jetbrains.com/dotnet/2021/02/01/resharper-2021-1-starts-eap/
      - https://blog.jetbrains.com/dotnet/2021/02/01/rider-2021-1-eap/

  - Subject: Avalonia 0.10.0 Release
    Timestamp: 00:18:00
    Links:
      - http://avaloniaui.net/blog/2020-12-29-avalonia-0.10.0-release

  - Subject: Choosing a ServiceLifetime
    Timestamp: 00:20:49
    Links:
      - https://jimmybogard.com/choosing-a-servicelifetime/
      - https://blog.ploeh.dk/2014/06/02/captive-dependency/

  - Subject: A Deep Dive into How .NET Builds and Ships
    Timestamp: 00:32:17
    Links:
  ...
  - Subject: The State of WebAssembly
    Timestamp: 00:55:55
    Links:
      - https://platform.uno/blog/the-state-of-webassembly-2020-and-2021/

  - Subject: Data Protection system in ASP.NET Core
    Timestamp: 01:03:05
    Links:
  ...
  - Subject: Source Generator libraries
    ...
    Links:
      ...
      - https://devblogs.microsoft.com/dotnet/whats-next-for-system-text-json/#c-source-generator-for-json-serialization-dotnet-runtime-1568

  - Subject: Making Win32 APIs More Accessible to More Languages
    Timestamp: 01:20:00
    Links:
